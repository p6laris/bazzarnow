        ...
        <div class="border border-neutral-800/80 bg-neutral-950/90 rounded-2xl shadow-[0_0_0_1px_rgba(255,255,255,0.03)] p-8 space-y-6">
            <header class="space-y-1">
                ...
                <p class="text-xs text-neutral-500">
                    Register to start shopping and managing your cart.
                </p>
            </header>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <div class="space-y-1 text-sm">
                    <label for="password_confirmation" class="text-neutral-300">Confirm password</label>
                    <input
            ...
            <p class="text-xs text-neutral-500 text-center">
                ...
                <a href="{{ route('login') }}" class="text-neutral-200 hover:underline">
                    Sign in
                </a>
            </p>
        </div>
